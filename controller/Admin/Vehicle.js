...
exports.create = async (req, res) => {
    try {
        ...
        const results = await Vehicle.create({
            name, vehicle_type_id, owner_agency, contact, driver_contact, ownershiptype, load_capacity, commission, insurance, image
        })
...
exports.findById = async (res, req) => {
    try {
        const { id } = req.params
...
exports.findByVehicletype = async (res, req) => {
    try {
        const { id } = req.params
        const results = await Vehicle.findAll({
